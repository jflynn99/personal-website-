...
export const metadata: Metadata = {
  title: "About",
  description: "Learn more about Joe Flynn - product manager, technologist, and builder.",
};
  ...
  return (
    <Container width="narrow">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <p className="text-muted leading-relaxed">
          I&apos;m always happy to connect with fellow builders, product folks, and
          anyone interested in technology. Feel free to reach out!
        </p>
      </div>
        ...
        <div className="flex flex-wrap gap-4">
          {socialLinks.map((link) => (
            <a
              ...
              className="inline-flex items-center gap-2 rounded-lg border border-border px-4 py-2.5 text-sm font-medium transition-colors hover:bg-card hover:text-accent"
            >
              {link.icon}
              {link.name}
            </a>
